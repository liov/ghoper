...
import (
	...
	"fastService/controller/mail"
	"fastService/controller/upload"
...
func ActiveSendMail(c *fasthttp.RequestCtx) {
...
// ActiveAccount 激活账号
func ActiveAccount(c *fasthttp.RequestCtx) {
	var err error
	var user User
...
func ResetPasswordMail(c *fasthttp.RequestCtx) {
...
func VerifyResetPasswordLink(c *fasthttp.RequestCtx) {
...
// ResetPassword 重置密码
func ResetPassword(c *fasthttp.RequestCtx) {
...
func UpdatePassword(c *fasthttp.RequestCtx) {
...
func topN(c *fasthttp.RequestCtx, n int) {
...
// Top10 返回积分排名前10的用户
func Top10(c *fasthttp.RequestCtx) {
	topN(c, 10)
}

// Top100 返回积分排名前100的用户
func Top100(c *fasthttp.RequestCtx) {
	topN(c, 100)
}
...
// DeleteCareer 删除职业经历
func DeleteCareer(c *fasthttp.RequestCtx) {
...
// DeleteSchool 删除教育经历
func DeleteSchool(c *fasthttp.RequestCtx) {
