...
func GetArticles(c *fasthttp.RequestCtx) {
...
func articleValidation(c *fasthttp.RequestCtx, article *model.Article) (err error) {
...
// Create 创建文章
func AddArticle(c *fasthttp.RequestCtx) {
...
func historyArticle(c *fasthttp.RequestCtx, isDel uint) (model.ArticleHistory, model.Article, error) {
...
//修改文章
func EditArticle(c *fasthttp.RequestCtx) {
...
func DeleteArticle(c *fasthttp.RequestCtx) {
