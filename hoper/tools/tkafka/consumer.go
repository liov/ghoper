...
func SaramaConsumer() {
	...
	ulog.Info("consumer init success")
	...
	ulog.Info("start consume really")
...
ConsumerLoop:
	for {
		...
		case msg := <-partitionConsumer.Messages():
			...
			ulog.Info(nextOffset+1, "...", offsetString)
