...
type SendMessage struct {
	ID            uint          `gorm:"primary_key" json:"id"`
	CreatedAt     time.Time     `json:"created_at"`
	SendUser      protobuf.User `gorm:"ForeignKey:SenderUserID" json:"send_user"`
	RecipientUser protobuf.User `gorm:"ForeignKey:RecipientUserID" json:"recipient_user"`
